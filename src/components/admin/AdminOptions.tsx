...
import {
  OPEN_PROPERTIES_MODAL,
  RENDEr_PROPERTY_CREATE,
} from "../../atoms/OpenPropertiesModal.tsx";
      ...
      >
        {location.pathname.includes("properties") ? (
          <>
            ...
            <li>
              <a onClick={() => navigate("/api/admin/customers")}>Customers</a>
            </li>
            <li>
              <a onClick={() => navigate("/api/admin/papers/0")}>Products</a>
            </li>
          </>
          ...
          <>
            <li>
              <a onClick={() => setOpenCreateModal(true)}>CreatePaper</a>
            </li>
            <li>
              <a onClick={() => navigate("/api/admin/customers")}>Customers</a>
            </li>
