...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    customerOrdersDetail: (customerId: IdentificationDto, params: RequestParams = {}) =>
     ...
     */
    orderOrderentriesDetail: (orderId: IdentificationDto, params: RequestParams = {}) =>
     ...
     */
    customerPlaceOrderCreate: (customerId: IdentificationDto, data: OrderPlacedDto, params: RequestParams = {}) =>
      this.request<OrderMain, any>({
